...
public class Application3_linkedList {
    ...
    public static void main(String[] args) {
        ...
        // linkedList는 주소값을 출력해 주는건데 .toString이 숨어 있음
        // 라고 샘이 말함..?System.out.println("linkedList: " + linkedList.toString);
        ...
        linkedList.remove(2); // linkedList는 ArrayList와 달리 부분적인 요서 제거에서 성능이 우수하다.
        System.out.println("linkedList = " + linkedList);

        linkedList.clear(); // 안에 있는 전체 요소들을 제거할 때 사용
        System.out.println("linkedList: " + linkedList);
        System.out.println("isEmpty: " + linkedList.isEmpty()); // boolean
    }
