...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // 둘 다 같은 상수이자 숫자일 뿐 구분할 수 없음 (런타임 시점)
        ...
        System.out.println("Enter the subject number (0~2): ");
        ...
        switch (fieldNo) {
            ...
            case Subjects.ORACLE: subName = "Oracle"; break;
        }

        System.out.println("The subject you entered is: " + subName);

        // 같은 클래스에 속한 상수들을 순회(반복자/반복문) 할 수 없다. (필드가 총 몇 개고 어떤 필드들이 있는지)
        // 타입의 안정성을 보장할 수 없다.
